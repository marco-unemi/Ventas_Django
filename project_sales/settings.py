"""
Django settings for project_sales project.
...
SECRET_KEY = 'django-insecure-(hjcc0&9us#mja3raq0pu$l@sp@2sp5ct982d3rhtbmuv(7x(='
...
ROOT_URLCONF = 'project_sales.urls'
...
WSGI_APPLICATION = 'project_sales.wsgi.application'
